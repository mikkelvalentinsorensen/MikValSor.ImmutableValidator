...
namespace MikValSor.Immutable
{
	...
	public class UnableToGetFieldValueException : NotImmutableException
	{
		...
		/// </param>
		public UnableToGetFieldValueException(string message) : base(message)
		{
		}
		...
		/// </param>
		public UnableToGetFieldValueException(string message, Exception innerException) : base(message, innerException)
		{
		}
		...
		/// </exception>
		protected UnableToGetFieldValueException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
}
