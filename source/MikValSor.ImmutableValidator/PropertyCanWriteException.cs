...
namespace MikValSor.Immutable
{
	...
	public class PropertyCanWriteException : NotImmutableException
	{
		...
		/// </param>
		public PropertyCanWriteException(string message, Exception innerException) : base(message, innerException)
		{
		}
		...
		/// </exception>
		protected PropertyCanWriteException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
}
