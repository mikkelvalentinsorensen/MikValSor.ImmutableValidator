// <copyright file="NotImmutableException.cs">
...
namespace MikValSor.Immutable
{
    ...
    /// <summary>Base class for exceptions throwen when classes are being validatet for immutablilty.</summary>
    [Serializable]
    public abstract class NotImmutableException : Exception
    {
        /// <summary>Initializes a new instance of the <see cref="NotImmutableException"/> class.</summary>
        /// <param name="message">The message that describes the error.</param>
        protected NotImmutableException(string message)
            : base(message)
        {
        }
        ...
        protected NotImmutableException(string message, Exception innerException)
        ...
        protected NotImmutableException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
