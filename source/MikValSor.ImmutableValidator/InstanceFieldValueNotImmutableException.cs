// <copyright file="InstanceFieldValueNotImmutableException.cs">
...
namespace MikValSor.Immutable
{
    ...
    /// <summary>Exception class used to signal when classes field value is set to a value that is mutable.</summary>
    [Serializable]
    public class InstanceFieldValueNotImmutableException : NotImmutableException
    {
        ...
        public InstanceFieldValueNotImmutableException()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="InstanceFieldValueNotImmutableException"/> class.</summary>
        /// <param name="message">The message that describes the error.</param>
        public InstanceFieldValueNotImmutableException(string message)
            : base(message)
        {
        }
        ...
        public InstanceFieldValueNotImmutableException(string message, Exception innerException)
        ...
        protected InstanceFieldValueNotImmutableException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
