...
namespace MikValSor.Immutable
{
	...
	public class UnableToGetPropertyValueException : NotImmutableException
	{
		...
		/// </param>
		public UnableToGetPropertyValueException(string message) : base(message)
		{
		}
		...
		/// </param>
		public UnableToGetPropertyValueException(string message, Exception innerException) : base(message, innerException)
		{
		}
		...
		/// </exception>
		protected UnableToGetPropertyValueException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
}