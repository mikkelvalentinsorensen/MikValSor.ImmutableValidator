...
namespace MikValSor.Immutable
{
	...
	public class TypeFieldNotImmutableException : NotImmutableException
	{
		...
		/// </param>
		public TypeFieldNotImmutableException(string message) : base(message)
		{
		}
		...
		/// </param>
		public TypeFieldNotImmutableException(string message, Exception innerException) : base(message, innerException)
		{
		}
		...
		/// </exception>
		protected TypeFieldNotImmutableException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
}
