// <copyright file="TypeIsArrayException.cs">
...
namespace MikValSor.Immutable
{
    ...
    /// <summary>Exception class for signaling the type is an array and i there for is mutable.</summary>
    [Serializable]
    public class TypeIsArrayException : NotImmutableException
    {
        /// <summary>Initializes a new instance of the <see cref="TypeIsArrayException"/> class.</summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        /// <param name="innerException">The exception that is the cause of the current exception, or a null reference (Nothing in Visual Basic) if no inner exception is specified.</param>
        public TypeIsArrayException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        /// <summary>Initializes a new instance of the <see cref="TypeIsArrayException"/> class.</summary>
        public TypeIsArrayException()
        {
        }

        /// <summary>Initializes a new instance of the <see cref="TypeIsArrayException"/> class.</summary>
        /// <param name="message">The message that describes the error.</param>
        public TypeIsArrayException(string message)
            : base(message)
        {
        }
        ...
        internal TypeIsArrayException(Type type)
            : base($"Type: {type.FullName}")
        {
        }
        ...
        protected TypeIsArrayException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
