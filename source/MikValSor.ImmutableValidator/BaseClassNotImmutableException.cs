// <copyright file="BaseClassNotImmutableException.cs">
...
namespace MikValSor.Immutable
{
    ...
    /// <summary>Exception class for cases where the base class is the course for class that are mutable.</summary>
    [Serializable]
    public class BaseClassNotImmutableException : NotImmutableException
    {
        ...
        public BaseClassNotImmutableException(string message, Exception innerException)
        ...
        public BaseClassNotImmutableException(string message)
            : base(message)
        {
        }
        ...
        protected BaseClassNotImmutableException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
