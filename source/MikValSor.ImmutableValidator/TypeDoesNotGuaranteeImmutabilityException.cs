...
namespace MikValSor.Immutable
{
	...
	public class TypeDoesNotGuaranteeImmutabilityException : NotImmutableException
    {
		...
		/// </param>
		public TypeDoesNotGuaranteeImmutabilityException(string message) : base(message)
		{
		}
		...
		/// </param>
		public TypeDoesNotGuaranteeImmutabilityException(string message, Exception innerException) : base(message, innerException)
		{
		}
		...
		/// </exception>
		protected TypeDoesNotGuaranteeImmutabilityException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
}
